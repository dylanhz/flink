    ...
    public Bitmap getValue(BitmapAndWithRetractAccumulator acc) {
        ...
        try {
            for (Map.Entry<Integer, Integer> entry : acc.valueCount.entries()) {
                // We require count == bitmapCount because:
                // 1. Using >= would accept value when bitmapCount is temporarily reduced by early
                //    deletes (out-of-order), causing count > bitmapCount and false positives, which
                //    makes the result unstable.
                // 2. Using == is more conservative and avoids false positives.
                //
                // For example:
                //       Case      | RowKind | Bitmap  | Result(>=) | Result(==)
                //  ------------------------------------------------------------
                //                 |   +I    | [1,2,3] |   [1,2,3]  |   [1,2,3]
                //                 |   +I    | [1,2]   |   [1,2]    |   [1,2]
                //      ordered    |   +I    | [2,3]   |   [2]      |   [2]
