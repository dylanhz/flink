...
@Internal
public final class BitmapXorAggFunction extends BuiltInAggregateFunction<Bitmap, Bitmap> {
    ...
    public void accumulate(Bitmap acc, @Nullable Bitmap bitmap) {
        acc.xor(bitmap);
    }

    public void retract(Bitmap acc, @Nullable Bitmap bitmap) {
        acc.xor(bitmap);
    }
